...
const SearchResults = () => {
    ...
    const [committedQuery, setCommittedQuery] = useState(initialQuery); // only updates on Search click
    ...
    const fetchResults = useCallback(async () => {
        ...
        try {
            ...
            const data = await searchService.search(committedQuery, filters);
    ...
    }, [committedQuery, scope, hsCode, selectedCountry, variantName, subcatId]);

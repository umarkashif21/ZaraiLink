...
if _sa_path and not os.path.isabs(_sa_path):
    # Resolve relative to BASE_DIR (backend/) so ../vertex-sa.json → Zarailink-Code/vertex-sa.json
    _sa_path = str((BASE_DIR / _sa_path).resolve())
VERTEX_SA_PATH   = _sa_path
